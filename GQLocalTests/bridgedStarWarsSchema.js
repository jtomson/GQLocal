...
/**
 * the 'gql' variable is magically available
 */
...
var episodeEnum = new gql.GraphQLEnumType({
  name: 'Episode',
 ...
 *   }
 */
var characterInterface = new gql.GraphQLInterfaceType({
  name: 'Character',
  ...
  fields: () => ({
    ...
    appearsIn: {
      type: new gql.GraphQLList(episodeEnum),
      description: 'Which movies they appear in.',
    },
  }),
  resolveType: character => {
    console.log("Resolving character");
    return gql.bridgedResolve("getHuman", {}, [character.id]) ? humanType : droidType;
  }
});
 ...
 *   }
 */
var humanType = new gql.GraphQLObjectType({
  name: 'Human',
  ...
  fields: () => ({
    ...
    friends: {
      ...
      description: 'The friends of the human, or an empty list if they ' +
                   'have none.',
      resolve: human => gql.bridgedResolve("getFriends", {}, [human]),
    },
    appearsIn: {
      type: new gql.GraphQLList(episodeEnum),
      description: 'Which movies they appear in.',
 ...
 *   }
 */
var droidType = new gql.GraphQLObjectType({
  name: 'Droid',
  ...
  fields: () => ({
    ...
    friends: {
      ...
      description: 'The friends of the droid, or an empty list if they ' +
                   'have none.',
      resolve: droid => gql.bridgedResolve("getFriends", {}, [droid]),
    },
    appearsIn: {
      type: new gql.GraphQLList(episodeEnum),
      description: 'Which movies they appear in.',
